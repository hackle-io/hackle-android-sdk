...
import io.hackle.android.internal.workspace.config.WorkspaceConfigFetcher
...
class WorkspaceConfigFetcherTest {

    private lateinit var httpClient: OkHttpClient
    private lateinit var sut: WorkspaceConfigFetcher

    @Before
    fun before() {
        httpClient = mockk()
        sut = WorkspaceConfigFetcher(Sdk("key", "name", "version"), "http://localhost", httpClient)
    }

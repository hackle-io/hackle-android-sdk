...
internal class InAppMessageDtoTest {
    ...
    fun `inAppMessage config test`() {
        ...
        expectThat(iam.messageContext.messages[0].images[0].action?.type).isEqualTo(WEB_LINK)
        ...
        expectThat(iam.messageContext.messages[0].images[1].action?.type).isEqualTo(WEB_LINK)
        ...
        expectThat(iam.messageContext.messages[0].buttons[0].action.type).isEqualTo(HIDDEN)
        ...
        expectThat(iam.messageContext.messages[0].buttons[1].action.type).isEqualTo(WEB_LINK)
        ...
        expectThat(iam.messageContext.messages[0].closeButton?.action?.type).isEqualTo(CLOSE)

        expectThat(iam.messageContext.messages[0].action?.behavior).isEqualTo(CLICK)
        expectThat(iam.messageContext.messages[0].action?.type).isEqualTo(LINK_AND_CLOSE)

...
internal class RemoteConfigImplTest {
    ...
    fun setUp() {
        ...
        sut = HackleRemoteConfigImpl(hackleAppCore, mockk())
    }
    ...
    fun `getString은 core의 remoteConfig 결과를 반환한다`() {
        ...
        every { hackleAppCore.remoteConfig(key, ValueType.STRING, defaultValue, any(), HackleAppContext.DEFAULT) } returns mockDecision
    ...
    fun `getInt은 core의 remoteConfig 결과를 int로 변환하여 반환한다`() {
        ...
        every { hackleAppCore.remoteConfig(key, ValueType.NUMBER, defaultValue, any(), HackleAppContext.DEFAULT) } returns mockDecision
    ...
    fun `getBoolean은 core의 remoteConfig 결과를 boolean로 변환하여 반환한다`() {
        ...
        every { hackleAppCore.remoteConfig(key, ValueType.BOOLEAN, defaultValue, any(), HackleAppContext.DEFAULT) } returns mockDecision

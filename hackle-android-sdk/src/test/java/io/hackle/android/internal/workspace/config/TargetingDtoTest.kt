...
internal class TargetingDtoTest {
    ...
    fun `TargetRuleDto creation and properties`() {
        ...
        val matchDto =
            TargetDto.MatchDto(type = "EQ", operator = "EQUALS", valueType = "STRING", values = listOf("mobile"))
    ...
    fun `TargetDto equals and hashCode`() {
        ...
        val matchDto =
            TargetDto.MatchDto(type = "GT", operator = "GREATER_THAN", valueType = "NUMBER", values = listOf(18))
        val conditionDto = TargetDto.ConditionDto(key = keyDto, match = matchDto)
    ...
    fun `MatchDto equals and hashCode`() {
        val match1 =
            TargetDto.MatchDto(type = "GT", operator = "GREATER_THAN", valueType = "NUMBER", values = listOf(10))
        val match2 =
            TargetDto.MatchDto(type = "GT", operator = "GREATER_THAN", valueType = "NUMBER", values = listOf(10))
    ...
    fun `TargetRuleDto equals and hashCode`() {
        ...
        val matchDto =
            TargetDto.MatchDto(type = "EQ", operator = "EQUALS", valueType = "STRING", values = listOf("123"))
        val conditionDto = TargetDto.ConditionDto(key = keyDto, match = matchDto)
        val targetDto = TargetDto(conditions = listOf(conditionDto))
    ...
    fun `ConditionDto copy method`() {
        ...
        val matchDto =
            TargetDto.MatchDto(type = "EQ", operator = "EQUALS", valueType = "STRING", values = listOf("value"))

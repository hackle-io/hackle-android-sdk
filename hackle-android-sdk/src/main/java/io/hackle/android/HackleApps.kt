...
internal object HackleApps {
    ...
    fun create(context: Context, sdkKey: String, config: HackleConfig): HackleApp {
        ...
        val inAppMessageEventActorFactory = InAppMessageEventActorFactory(
            actors = listOf(
                InAppMessageImpressionViewEventActor(),
                InAppMessageActionViewEventActor(inAppMessageActionHandlerFactory),
                InAppMessageCloseViewEventActor()
            )
        )
        val inAppMessageViewEventHandlerFactory = InAppMessageViewEventHandlerFactory(
            handlers = listOf(
                ...
                InAppMessageViewEventActionHandler(inAppMessageEventActorFactory),
            )
        )

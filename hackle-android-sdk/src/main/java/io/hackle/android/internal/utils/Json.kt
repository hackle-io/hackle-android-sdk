...
internal inline fun <reified T> Gson.fromJson(json: JsonElement): T = fromJson(json, gsonTypeRef<T>().type)

internal inline fun <reified T> String.parseJson(): T = GSON.fromJson(this)
internal inline fun <reified T> JsonElement.parseJson(): T = GSON.fromJson(this)

...
internal fun InAppMessageDto.toInAppMessageOrNull(): InAppMessageConfig? {
...
internal fun InAppMessageDto.PeriodDto.toPeriodOrNull(): InAppMessage.Period? {
    return when (type) {
        "IMMEDIATE" -> InAppMessage.Period.Always
        "CUSTOM" -> InAppMessage.Period.Custom(
            startMillisInclusive = startMillisInclusive ?: return null,
            endMillisExclusive = endMillisExclusive ?: return null
        )
...
internal fun InAppMessageDto.TimetableSlotDto.toTimetableSlotOrNull(): InAppMessage.Timetable.Slot? {
    return InAppMessage.Timetable.Slot(

...
internal class InAppMessageModalActivity : FragmentActivity(), HackleActivity {

    private lateinit var messageView: InAppMessageModalView
    ...
    private fun initialize(): Boolean {
        ...
        if (messageView !is InAppMessageModalView) {
            messageView.close()
            return false
        }

        val messageId = intent.getLongExtra(InAppMessageModalView.MESSAGE_ID, -1)

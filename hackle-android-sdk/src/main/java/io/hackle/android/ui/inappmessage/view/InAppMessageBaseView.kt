...
internal fun InAppMessageView.createButtonClickListener(button: InAppMessage.Message.Button): OnClickListener {
    return OnClickListener {
        val event = InAppMessageViewEvent.action(this, button.action, button)
        handle(event)
    }
}
...
internal fun InAppMessageView.createMessageClickListener(): OnClickListener {
    return OnClickListener {
        ...
        val event = InAppMessageViewEvent.action(this, action, InAppMessage.ActionArea.MESSAGE)
        handle(event)
    }
}
...
internal fun InAppMessageView.createImageClickListener(
    ...
    return OnClickListener {
        ...
        val event = InAppMessageViewEvent.action(this, action, image, order)
        handle(event)
    }
}
